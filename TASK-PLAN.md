...
- **Active batch:** K — T34 release evidence and publication
...
| T34 | Run the clean aggregate and republish with green GitHub CI                      | In Progress | T26, T29, T31, T33, T35      | K3 (Sequential)           | `docs/release-readiness.md`, coordinator-only `TASK-PLAN.md`, Git history, and the existing GitHub refs; product behavior remains read-only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Release verification and publication                                           | Clean-clone `pnpm verify`; GitHub CI             | T34A first passes the isolated seven-scenario reset and exact aggregate. After T35, the primary reset returns the same seven hashes and exact `pnpm verify` exits 0 with 195 unit, 57 runnable integration plus one intentional Google skip, 17 Vitest E2E, eight browser, and 19 security tests. The clean-room path proves lossless feedback, zero network calls, zero dry-run and replay writes, and one verified synthetic rename. Formatting, docs, explicit no-real-data, two secret scans, package validation at 206 files and 894,856 bytes, and `git diff --check` pass. The parent baseline remains exactly 57/58 with only the known masthead failure. Release evidence is reconciled. Awaiting the commit, non-force pushes, remote-hash reconciliation, and successful GitHub Actions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
