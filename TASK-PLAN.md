...
- **Active batch:** K — T36 CI browser prerequisite, then T34 republication
...
| T34 | Run the clean aggregate and republish with green GitHub CI                      | In Progress | T26, T29, T31, T33, T35, T36 | K5 (Sequential)           | `docs/release-readiness.md`, coordinator-only `TASK-PLAN.md`, Git history, and the existing GitHub refs; product behavior remains read-only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Release verification and publication                                           | Clean-clone `pnpm verify`; GitHub CI             | T34A and the corrected primary aggregate pass locally. Commit `adaa5608629107ff84fa28db238a15d680103e79` is pushed without force and both remote refs match it. GitHub run `31280518814` passes install, build, lint, typecheck, 195 unit tests, 57 runnable integrations, and 17 Vitest E2E tests, then fails only because Chromium is absent. T36 adds the exact browser prerequisite with a RED/GREEN order contract. The post-T36 reset-state aggregate exits 0 with 196 unit, 57 runnable integration plus one Google skip, 17 Vitest E2E, eight browser, and 19 security tests; clean-room and package checks pass at 206 files and 894,856 bytes. Awaiting the correction commit, non-force pushes, matching remote hashes, and a successful GitHub run.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
