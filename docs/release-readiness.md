...
| `pnpm verify`                                           | Exit 0. Formatting, lint, strict types, 193 unit tests, 57 runnable integration tests, 17 Vitest end-to-end tests, eight browser tests, 19 security tests, builds, SQLite, boundaries, and package checks passed. The opt-in Google sandbox test was the only skip. |
...
| `pnpm package:manifest:check`                           | Exit 0. The package contains 206 controlled files and 894,053 unpacked bytes. Tests, fixtures, task reports, generated artifacts, tokens, databases, logs, nested dependencies, and build metadata are excluded.                                                    |
...
| --: | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Clean install and all quality gates                                                          | `pnpm verify`; `pnpm verify:package`; the documented `pnpm install --frozen-lockfile` clean-room path                                                                                             | Pass. The clean room installed offline, built source, and completed the quick start.                                                                                                                                                                                             |
