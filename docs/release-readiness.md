...
| `pnpm verify`                                           | Exit 0. Formatting, lint, strict types, 195 unit tests, 57 runnable integration tests, 17 Vitest end-to-end tests, eight browser tests, 19 security tests, builds, SQLite, boundaries, and package checks passed. The opt-in Google sandbox test was the only skip. |
